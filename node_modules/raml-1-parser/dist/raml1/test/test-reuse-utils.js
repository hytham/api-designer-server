...
function simulateTypingForFile(filePath, restrictions) {
...
function testReuse(newContent, specPath, reuseNode, expectReuse) {
    ...
    var reusingApi = index.loadRAMLSync(specPath, [], {
    ...
    var nonReusingApi = index.loadRAMLSync(specPath, [], {
        fsResolver: fsResolver
    }).expand();
...
function testReuseByBasicTyping(specPath, byWords) {
